...
local CARGO_SUPPLY_CONFIG = {
    red = {
        supplyAirfields = { "Barville", "Flers", "Evreux", "Fecamp-Benouville", "Lessay", "Conches" }, -- replace with your RED supply airbase names
        cargoTemplate = "CARGO_PLANE_RED",    -- replace with your RED cargo aircraft template name
        threshold = 0.90                     -- ratio below which to trigger resupply (testing)
    },
    blue = {
        supplyAirfields = { "Ford", "Tangmere", "Stoney Cross" }, -- replace with your BLUE supply airbase names
        cargoTemplate = "CARGO_PLANE_BLUE",   -- replace with your BLUE cargo aircraft template name
        threshold = 0.90                     -- ratio below which to trigger resupply (testing)
    }
}
