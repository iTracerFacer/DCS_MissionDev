...
ctld.pickupZones = {
    ...
    { "pickzoneDeTolhuin", "red", -1, "yes", 0 },
    { "pickzoneRioGrande", "red", -1, "yes", 0 },
...
ctld.spawnableCrates = {
    ...
    ["AA short range"] = {
        ...
        { weight = 401, desc = "SPAAA Vulcan M163", unit = "SPAAA Vulcan M163", side = 2, cratesRequired = 1 },
        { weight = 402, desc = "SPAAA Gepard", unit = "SPAAA Gepard", side = 2, cratesRequired = 1 },
    },
    ["AA mid range"] = {
        -- HAWK System
