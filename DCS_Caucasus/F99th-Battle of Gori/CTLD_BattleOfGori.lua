...
ctld.AASystemLimitRED = 1 -- Red side limit

ctld.AASystemLimitBLUE = 1 -- Blue side limit
...
ctld.pickupZones = {
    { "pickzone1", "blue", 10, "yes", 0, 101 },
    { "pickzone2", "blue", 10, "yes", 0, 102 },
    { "pickzone3", "blue", 10, "yes", 0, 103 },
    { "pickzone4", "blue", 10, "yes", 0, 104 },
    { "pickzone5", "blue", 10, "yes", 0, 105 },
    { "pickzone6", "blue", 10, "yes", 0, 106 },
	{ "pickzone7", "blue", 10, "yes", 0, 107 },
	{ "pickzone8", "blue", 10, "yes", 0, 108 },
...
ctld.loadableGroups = {
    {name = "Wounded Troops", inf = 2 }, -- will make a loadable group with 5 infantry, 2 MGs and 2 anti-tank for both coalitions
        ...
        for _crateName, _dontUse in pairs(_crates) do
            ...
            if _crate ~= nil and _crate:getLife() > 0
                ...
                if _dist <= _triggerZone.radius then
					...
					MESSAGE:New("NATO Helo Squadrons have delivered cargo to the forward MASH unit. Blue team gains 1 point!", 15, "Alert!", true)
					BlueAddScore(2)
					StatBlueCratesMoved = StatBlueCratesMoved + 2
                end
            end
        end
    end
        ...
        if _onboard.troops ~= nil and #_onboard.troops.units > 0 then
            if ctld.inAir(_heli) == false or ctld.safeToFastRope(_heli) then
                ...
                if _extractZone == false then
					...
					MESSAGE:New("NATO Helo Squadrons have have rescued 2 people from the town of Gori!\n\n", 10, "Rescue!", true):ToAll() --This is a moose function
					ScoreAddBlue(2)
					StatBlueRescued = StatBlueRescued + 2
                end
            else
