...
ctld.numberOfTroops = 4 -- default number of troops to load on a transport heli or C-130 
...
ctld.pickupZones = {
    { "pickzone1", "blue", 4, "yes", 0, 101 },
    { "pickzone2", "blue", 4, "yes", 0, 102 },
    { "pickzone3", "blue", 4, "yes", 0, 103 },
    { "pickzone4", "blue", 2, "yes", 0, 104 },
    { "pickzone5", "blue", 2, "yes", 0, 105 },
    { "pickzone6", "blue", 4, "yes", 0, 106 },
	{ "pickzone7", "blue", 4, "yes", 0, 107 },
	{ "pickzone8", "blue", 4, "yes", 0, 108 },
	{ "pickzone9", "blue", 4, "yes", 0, 109 },
	{ "pickzone10", "blue", 2, "yes", 0, 110 },
	{ "pickzone11", "blue", 2, "yes", 0, 111 },
	{ "pickzone12", "blue", 2, "yes", 0, 112 },
	{ "pickzone13", "blue", 4, "yes", 0, 113 },
	{ "pickzone14", "blue", 4, "yes", 0, 114 },
	{ "pickzone15", "blue", 4, "yes", 0, 115 },	
	{ "pickzone16", "blue", 2, "yes", 0, 116 },	
	{ "pickzone17", "blue", 2, "yes", 0, 117 },	
	{ "pickzone18", "blue", 2, "yes", 0, 118 },
	{ "pickzone19", "blue", 2, "yes", 0, 119 },
	{ "pickzone20", "blue", 2, "yes", 0, 120 },
	{ "pickzone21", "blue", 2, "yes", 0, 121 },
}
...
ctld.unitActions = {
	...
	-- ["Mi-8MTV2"] = {crates=false, troops=true}
}
...
ctld.loadableGroups = {
    {name = "Wounded Troops", inf = 1 }, -- will make a loadable group with 5 infantry, 2 MGs and 2 anti-tank for both coalitions
        ...
        for _crateName, _dontUse in pairs(_crates) do
            ...
            if _crate ~= nil and _crate:getLife() > 0
                ...
                if _dist <= _triggerZone.radius then
					...
					MESSAGE:New("NATO Helo Squadrons have delivered cargo to a MASH unit. Blue team gains 1 point!", 15, "Alert!", true)
					
					-- Added by TracerFacer \/\/\/\\/\/\/\/\/
        ...
        if _onboard.troops ~= nil and #_onboard.troops.units > 0 then
            if ctld.inAir(_heli) == false or ctld.safeToFastRope(_heli) then
                ...
                if _extractZone == false then
					...
					MESSAGE:New("NATO Helo Squadrons have have rescued a wounded pilot!\n\n", 10, "Rescue!", true):ToAll() --This is a moose function
					ScoreAddBlue(1)
...
function ctld.loadTroops(_heli, _troops, _numberOrTemplate)
    ...
    if _troops then
        ...
        trigger.action.outTextForCoalition(_heli:getCoalition(), ctld.getPlayerNameOrType(_heli) .. " loaded wounded troops into " .. _heli:getTypeName(), 10)
...
function ctld.loadTroopsFromZone(_args)
    ...
    if ctld.troopsOnboard(_heli, _troops) then
        ...
        if _troops then
            ctld.displayMessageToGroup(_heli, "You already have wounded troops onboard.", 10)
        else
    ...
    elseif _zone.inZone == true then
        ...
        if _allowExtract then
            ...
            ctld.displayMessageToGroup(_heli, "You are not in a pickup zone, fly to the town of Gori, and look for the blue smoke.", 10)
        end
...
function ctld.unloadTroops(_args)
    ...
    if not ctld.troopsOnboard(_heli, _troops)  then
        ...
        if _zone.inZone == true  then
            ...
            if _troops then
                ctld.displayMessageToGroup(_heli, "Dropped wounded troops back to base", 20)
...
function ctld.checkTroopStatus(_args)
    ...
    if _onboard == nil then
        ...
        if _troops ~= nil and _troops.units ~= nil and #_troops.units > 0 then
            _txt = _txt .. " " .. #_troops.units .. " wounded troops onboard\n"
        end
        ...
        if _txt ~= "" then
            ...
            if ctld.inTransitFOBCrates[_heli:getName()] == true then
                ...
                ctld.displayMessageToGroup(_heli, "No wounded troops onboard", 10)
            end
        end
    end
end
