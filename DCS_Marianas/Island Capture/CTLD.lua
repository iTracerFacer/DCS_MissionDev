...
ctld.hawkLaunchers = 1 -- controls how many launchers to add to the hawk when its spawned.
...
ctld.pickupZones = {
    { "pickzone1", "blue", -1, "no", 0 },
    
    { "pickzone1-1", "blue", -1, "no", 0 },
    { "pickzone1-2", "blue", -1, "no", 0 },
    { "pickzone1-3", "blue", -1, "no", 0 },
    { "pickzone1-4", "blue", -1, "no", 0 },
    { "pickzone1-5", "blue", -1, "no", 0 },
    { "pickzone1-6", "blue", -1, "no", 0 },
    { "pickzone1-7", "blue", -1, "no", 0 },
    
    
    { "pickzone2", "blue", -1, "no", 0 },
...
--    {name = "Standard Group", inf = 6, mg = 2, at = 2 }, -- will make a loadable group with 6 infantry, 2 MGs and 2 anti-tank for both coalitions
    {name = "Anti Air (3)", aa = 3  },
    {name = "Anti Tank (8)", inf = 2, at = 6  },
    {name = "SpecOps (10)", inf = 6, mg = 2, at = 2  },
    {name = "Rangers (24)", inf = 20, mg = 2, at = 2  },
...
--    {name = "Single JTAC (1)", jtac = 1 }, -- will make a loadable group witha single JTAC soldier for both coalitions
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 250, desc = "MBT T-90", unit = "MBT T-90", side = 1 },
        { weight = 255, desc = "MBT M1A2 Abrams", unit = "M-1 Abrams", side = 2 },
