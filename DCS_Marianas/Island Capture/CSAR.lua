...
csar.csarOncrash = false -- If set to true, will generate a csar when crash as well.
...
function csar.rescuePilots(_heliUnit)
  ...
  -- Added By TracerFacer to grant scores to players. 
  
  AddScoreBlueCSARComplete()
