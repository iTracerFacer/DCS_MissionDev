...
ctld_blue = CTLD:New( coalition.side.BLUE, {"Transport", "TRANSPORT", "APACHE", "HIND", "HUEY", "MI8"}, "Transport Helos")
...
--Add (normal, round!) zones for loading troops and crates and dropping, building crates
   ...
   ctld_blue:AddCTLDZone("Haifa Supply",CTLD.CargoZoneType.LOAD,SMOKECOLOR.Blue,true,true)
   ctld_blue:AddCTLDZone("Naqoura Supply",CTLD.CargoZoneType.LOAD,SMOKECOLOR.Blue,true,true)
   ctld_blue:AddCTLDZone("Beirut Supply",CTLD.CargoZoneType.LOAD,SMOKECOLOR.Blue,true,true)
...
-- add infantry unit called "Anti-Tank Small" using template "ATS", of type TROOP with size 3
   ...
   ctld_blue:AddCratesCargo("APC M113",{"APC"},CTLD_CARGO.Enum.VEHICLE,1,nil,10,"Anti-Tank")
...
function addStockBlue() -- used in the ME when a base is captured. 
  ...
  ctld_blue:AddStockCrates("APC M113",addAPC)
