...
local SPAWN_SCHED_BLUE_ARMOR = 600  -- Spawn Blue Armor groups every 300 seconds

local ASSIGN_TASKS_SCHED = 900      -- Assign tasks to groups every 600 seconds. New groups added will wait this long before moving.

-- !!!! REQUIRED !!!!!
-- Place in the mission an infantry unit called "RedInfantryGroup" and "BlueInfantryGroup" for each side. Set to LATE ACTIVATE.
-- Place in the mission an armor unit called "RedArmorGroup" and "BlueArmorGroup" for each side. Set to LATE ACTIVATE.
...
local redZones = {
    ZONE:New("FrontLine-21"),
    ZONE:New("FrontLine-22"),
    ZONE:New("FrontLine-23"),
    ZONE:New("FrontLine-24"),
    ZONE:New("FrontLine-25"),
    ZONE:New("FrontLine-26"),
    ZONE:New("FrontLine-27"),
    ZONE:New("FrontLine-28"),
    ZONE:New("FrontLine-29"),
    ZONE:New("FrontLine-30"),
    ZONE:New("FrontLine-31"),
    ZONE:New("FrontLine-32"),
    ZONE:New("FrontLine-33"),
    ZONE:New("FrontLine-34"),
    ZONE:New("FrontLine-35"),
    ZONE:New("FrontLine-36"),
    ZONE:New("FrontLine-37"),
    ZONE:New("FrontLine-38"),
    ZONE:New("FrontLine-39"),
    ZONE:New("FrontLine-40")
}

local blueZones = {
    ZONE:New("FrontLine-1"),
    ZONE:New("FrontLine-2"),
    ZONE:New("FrontLine-3"),
    ZONE:New("FrontLine-4"),
    ZONE:New("FrontLine-5"),
    ZONE:New("FrontLine-6"),
    ZONE:New("FrontLine-7"),
    ZONE:New("FrontLine-8"),
    ZONE:New("FrontLine-9"),
    ZONE:New("FrontLine-10"),
    ZONE:New("FrontLine-11"),
    ZONE:New("FrontLine-12"),
    ZONE:New("FrontLine-13"),
    ZONE:New("FrontLine-14"),
    ZONE:New("FrontLine-15"),
    ZONE:New("FrontLine-16"),
    ZONE:New("FrontLine-17"),
    ZONE:New("FrontLine-18"),
    ZONE:New("FrontLine-19"),
    ZONE:New("FrontLine-20")
}
...
local redWarehouses = {
    STATIC:FindByName("RedWarehouse-1-1"), -- Static units key of off unit name in mission editor rather than just the name field. weird. =\ (hours wasted! ha!)
    ...
    STATIC:FindByName("RedWarehouse-7-1"),
    STATIC:FindByName("RedWarehouse-8-1"),
    STATIC:FindByName("RedWarehouse-9-1"),
    STATIC:FindByName("RedWarehouse-10-1"),
    STATIC:FindByName("RedWarehouse-11-1"),
    STATIC:FindByName("RedWarehouse-12-1"),
    STATIC:FindByName("RedWarehouse-13-1"),
    STATIC:FindByName("RedWarehouse-14-1"),
    STATIC:FindByName("RedWarehouse-15-1")
